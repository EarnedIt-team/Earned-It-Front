...
@override
int get hashCode => Object.hash(runtimeType,initialWish,imageForUpload,isTop5,canSubmit,priceError,isLoading);

@override
String toString() {
  return 'WishEditState(initialWish: $initialWish, imageForUpload: $imageForUpload, isTop5: $isTop5, canSubmit: $canSubmit, priceError: $priceError, isLoading: $isLoading)';
}
...
@useResult
$Res call({
 WishModel? initialWish, XFile? imageForUpload, bool isTop5, bool canSubmit, String priceError, bool isLoading
});
...
/// Create a copy of WishEditState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? initialWish = freezed,Object? imageForUpload = freezed,Object? isTop5 = null,Object? canSubmit = null,Object? priceError = null,Object? isLoading = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WishModel? initialWish,  XFile? imageForUpload,  bool isTop5,  bool canSubmit,  String priceError,  bool isLoading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WishEditState() when $default != null:
return $default(_that.initialWish,_that.imageForUpload,_that.isTop5,_that.canSubmit,_that.priceError,_that.isLoading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WishModel? initialWish,  XFile? imageForUpload,  bool isTop5,  bool canSubmit,  String priceError,  bool isLoading)  $default,) {final _that = this;
switch (_that) {
case _WishEditState():
return $default(_that.initialWish,_that.imageForUpload,_that.isTop5,_that.canSubmit,_that.priceError,_that.isLoading);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WishModel? initialWish,  XFile? imageForUpload,  bool isTop5,  bool canSubmit,  String priceError,  bool isLoading)?  $default,) {final _that = this;
switch (_that) {
case _WishEditState() when $default != null:
return $default(_that.initialWish,_that.imageForUpload,_that.isTop5,_that.canSubmit,_that.priceError,_that.isLoading);case _:
  return null;
...
class _WishEditState implements WishEditState {
  const _WishEditState({this.initialWish, this.imageForUpload, this.isTop5 = false, this.canSubmit = false, this.priceError = "", this.isLoading = false});
...
/// Create a copy of WishEditState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? initialWish = freezed,Object? imageForUpload = freezed,Object? isTop5 = null,Object? canSubmit = null,Object? priceError = null,Object? isLoading = null,}) {
