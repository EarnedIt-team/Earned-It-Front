...
mixin _$RankModel {
 ...
 int get userId; int get rank; String get nickname; int get score; bool? get public; String? get profileImage;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,rank,nickname,score,public,profileImage);

@override
String toString() {
  return 'RankModel(userId: $userId, rank: $rank, nickname: $nickname, score: $score, public: $public, profileImage: $profileImage)';
}
...
@useResult
$Res call({
 int userId, int rank, String nickname, int score, bool? public, String? profileImage
});
...
/// Create a copy of RankModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? rank = null,Object? nickname = null,Object? score = null,Object? public = freezed,Object? profileImage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int userId,  int rank,  String nickname,  int score,  bool? public,  String? profileImage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RankModel() when $default != null:
return $default(_that.userId,_that.rank,_that.nickname,_that.score,_that.public,_that.profileImage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int userId,  int rank,  String nickname,  int score,  bool? public,  String? profileImage)  $default,) {final _that = this;
switch (_that) {
case _RankModel():
return $default(_that.userId,_that.rank,_that.nickname,_that.score,_that.public,_that.profileImage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int userId,  int rank,  String nickname,  int score,  bool? public,  String? profileImage)?  $default,) {final _that = this;
switch (_that) {
case _RankModel() when $default != null:
return $default(_that.userId,_that.rank,_that.nickname,_that.score,_that.public,_that.profileImage);case _:
  return null;
...
class _RankModel implements RankModel {
  const _RankModel({required this.userId, required this.rank, required this.nickname, required this.score, this.public = false, this.profileImage});
...
/// Create a copy of RankModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? rank = null,Object? nickname = null,Object? score = null,Object? public = freezed,Object? profileImage = freezed,}) {
