...
import 'package:earned_it/view_models/self_login_auth_provider.dart';
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                ...
                SizedBox(
                  height: signUpState.isRequestAuth ? context.height(0.03) : 0,
                ),
                ...
                _buildSignTextField(
                  ...
                  "비밀번호",
                  controller:
                      signUpNotifier.passwordController, // Notifier의 컨트롤러 사용
                ...
                _buildSignTextField(
                  ...
                  helperWidget:
                      signUpState.isCheckPassword
                          ...
                          : null,
                  errorText:
                      signUpNotifier.checkPasswordController.text.isNotEmpty &&
                              !signUpState.isCheckPassword
                          ? "비밀번호가 다릅니다."
                          : null,
                ),
