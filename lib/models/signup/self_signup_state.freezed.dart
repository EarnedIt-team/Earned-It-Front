...
// 기본값 지정 시 @Default(false) 사용
 ...
 bool get isAvailablePassword; bool get isCheckPassword; bool get isAgreedToTerms; int get startTime;
...
@override
int get hashCode => Object.hash(runtimeType,isAvailableID,isRequestAuth,isAvailableCode,isSuccessfulCode,isObscurePassword,isAvailablePassword,isCheckPassword,isAgreedToTerms,startTime);

@override
String toString() {
  return 'SelfSignupState(isAvailableID: $isAvailableID, isRequestAuth: $isRequestAuth, isAvailableCode: $isAvailableCode, isSuccessfulCode: $isSuccessfulCode, isObscurePassword: $isObscurePassword, isAvailablePassword: $isAvailablePassword, isCheckPassword: $isCheckPassword, isAgreedToTerms: $isAgreedToTerms, startTime: $startTime)';
}
...
@useResult
$Res call({
 bool isAvailableID, bool isRequestAuth, bool isAvailableCode, bool isSuccessfulCode, bool isObscurePassword, bool isAvailablePassword, bool isCheckPassword, bool isAgreedToTerms, int startTime
});
...
/// Create a copy of SelfSignupState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isAvailableID = null,Object? isRequestAuth = null,Object? isAvailableCode = null,Object? isSuccessfulCode = null,Object? isObscurePassword = null,Object? isAvailablePassword = null,Object? isCheckPassword = null,Object? isAgreedToTerms = null,Object? startTime = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isAvailableID,  bool isRequestAuth,  bool isAvailableCode,  bool isSuccessfulCode,  bool isObscurePassword,  bool isAvailablePassword,  bool isCheckPassword,  bool isAgreedToTerms,  int startTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SelfSignupState() when $default != null:
return $default(_that.isAvailableID,_that.isRequestAuth,_that.isAvailableCode,_that.isSuccessfulCode,_that.isObscurePassword,_that.isAvailablePassword,_that.isCheckPassword,_that.isAgreedToTerms,_that.startTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isAvailableID,  bool isRequestAuth,  bool isAvailableCode,  bool isSuccessfulCode,  bool isObscurePassword,  bool isAvailablePassword,  bool isCheckPassword,  bool isAgreedToTerms,  int startTime)  $default,) {final _that = this;
switch (_that) {
case _SelfSignupState():
return $default(_that.isAvailableID,_that.isRequestAuth,_that.isAvailableCode,_that.isSuccessfulCode,_that.isObscurePassword,_that.isAvailablePassword,_that.isCheckPassword,_that.isAgreedToTerms,_that.startTime);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isAvailableID,  bool isRequestAuth,  bool isAvailableCode,  bool isSuccessfulCode,  bool isObscurePassword,  bool isAvailablePassword,  bool isCheckPassword,  bool isAgreedToTerms,  int startTime)?  $default,) {final _that = this;
switch (_that) {
case _SelfSignupState() when $default != null:
return $default(_that.isAvailableID,_that.isRequestAuth,_that.isAvailableCode,_that.isSuccessfulCode,_that.isObscurePassword,_that.isAvailablePassword,_that.isCheckPassword,_that.isAgreedToTerms,_that.startTime);case _:
  return null;
...
class _SelfSignupState implements SelfSignupState {
  const _SelfSignupState({this.isAvailableID = false, this.isRequestAuth = false, this.isAvailableCode = false, this.isSuccessfulCode = false, this.isObscurePassword = true, this.isAvailablePassword = false, this.isCheckPassword = false, this.isAgreedToTerms = false, this.startTime = 900});
...
/// Create a copy of SelfSignupState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isAvailableID = null,Object? isRequestAuth = null,Object? isAvailableCode = null,Object? isSuccessfulCode = null,Object? isObscurePassword = null,Object? isAvailablePassword = null,Object? isCheckPassword = null,Object? isAgreedToTerms = null,Object? startTime = null,}) {
