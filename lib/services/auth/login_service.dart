...
class LoginService {
  ...
  /// 자체 로그인을 활용해 서버에 요청합니다.
  Future<ApiResponse> selfLogin(String email, String password) async {
    try {
      ...
      final ApiResponse response = await _restClient.selflogin(requestBody);
