...
mixin _$WishModel {
 ...
 int get id; int get userId; String get name; int get price; String get itemImage; String get vendor; String get createdAt; bool get bought; bool get starred;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,name,price,itemImage,vendor,createdAt,bought,starred);

@override
String toString() {
  return 'WishModel(id: $id, userId: $userId, name: $name, price: $price, itemImage: $itemImage, vendor: $vendor, createdAt: $createdAt, bought: $bought, starred: $starred)';
}
...
@useResult
$Res call({
 int id, int userId, String name, int price, String itemImage, String vendor, String createdAt, bool bought, bool starred
});
...
/// Create a copy of WishModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? price = null,Object? itemImage = null,Object? vendor = null,Object? createdAt = null,Object? bought = null,Object? starred = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int userId,  String name,  int price,  String itemImage,  String vendor,  String createdAt,  bool bought,  bool starred)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WishModel() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.price,_that.itemImage,_that.vendor,_that.createdAt,_that.bought,_that.starred);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int userId,  String name,  int price,  String itemImage,  String vendor,  String createdAt,  bool bought,  bool starred)  $default,) {final _that = this;
switch (_that) {
case _WishModel():
return $default(_that.id,_that.userId,_that.name,_that.price,_that.itemImage,_that.vendor,_that.createdAt,_that.bought,_that.starred);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int userId,  String name,  int price,  String itemImage,  String vendor,  String createdAt,  bool bought,  bool starred)?  $default,) {final _that = this;
switch (_that) {
case _WishModel() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.price,_that.itemImage,_that.vendor,_that.createdAt,_that.bought,_that.starred);case _:
  return null;
...
class _WishModel implements WishModel {
  const _WishModel({required this.id, required this.userId, required this.name, required this.price, required this.itemImage, required this.vendor, required this.createdAt, required this.bought, required this.starred});
...
/// Create a copy of WishModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? price = null,Object? itemImage = null,Object? vendor = null,Object? createdAt = null,Object? bought = null,Object? starred = null,}) {
